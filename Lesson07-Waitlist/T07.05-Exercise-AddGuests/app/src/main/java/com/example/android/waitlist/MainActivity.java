...
//        TestUtil.insertFakeData(mDb);
    ...
    public void addToWaitlist(View view) {
        ...
        // DONE (11) Use Integer.parseInt to parse mNewPartySizeEditText.getText to an
        try {
        ...
        // mNewPartySizeEditText.getText().clear(); (20) To make the UI look nice, call .getText().clear() on both EditTexts, also call clearFocus() on mNewPartySizeEditText
